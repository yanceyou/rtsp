...
class Wfs {
 ...
 //   this.fileLoader.destroy();
  ...
  attachMedia(media, channelName='chX',mediaType='H264Raw', websocketURL='play2') { // 'H264Raw' 'FMp4'
    this.mediaType = mediaType;
    this.media = media;
    this.trigger(Event.MEDIA_ATTACHING, {media:media, channelName:channelName, mediaType:mediaType, websocketURL:websocketURL });
  }
